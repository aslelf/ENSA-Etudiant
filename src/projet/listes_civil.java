...
public class listes_civil extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					listes_civil frame = new listes_civil();
	...
	public listes_civil() {
		 setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			menuFichier3.setIcon(new ImageIcon(listes_civil.class.getResource("/image/icons8-menu-2-48.png")));
			...
			JLabel lblNewLabel_11 = new JLabel("Génie civil");
