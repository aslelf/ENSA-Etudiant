...
public class listes_info extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					listes_info frame = new listes_info();
	...
	public listes_info() {
		 setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			menuFichier3.setIcon(new ImageIcon(listes_info.class.getResource("/image/icons8-menu-2-48.png")));
			...
			JLabel lblNewLabel_11 = new JLabel("Génie informatique");
