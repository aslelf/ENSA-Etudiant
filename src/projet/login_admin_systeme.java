...
public class login_admin_systeme extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					login_admin_systeme frame = new login_admin_systeme();
	 ...
	 // creation de barre de text
		...
		next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (addCheck.equals("root") &&  apgCheck.equals("root") )
				{
					setVisible(false);
					EditionUtilisateur ms =new EditionUtilisateur();
