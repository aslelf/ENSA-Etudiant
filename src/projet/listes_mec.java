...
public class listes_mec extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					listes_mec frame = new listes_mec();
	...
	public listes_mec() {
		 setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			menuFichier3.setIcon(new ImageIcon(listes_mec.class.getResource("/image/icons8-menu-2-48.png")));
			...
			JLabel lblNewLabel_11 = new JLabel("Génie mécatronique");
