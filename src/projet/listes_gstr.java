...
public class listes_gstr extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					listes_gstr frame = new listes_gstr();
	...
	public listes_gstr() {
		 setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			...
			menuFichier3.setIcon(new ImageIcon(listes_gstr.class.getResource("/image/icons8-menu-2-48.png")));
			...
			JLabel lblNewLabel_11 = new JLabel("Génie des systèmes de télécommunication et réseaux");
