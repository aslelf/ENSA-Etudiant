...
public class login_directeur extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					login_directeur frame = new login_directeur();
			...
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					try 
					{
						...
						String sql = "Select * From utilisateur Where login= '"+username.getText()+"'and password = '"+passwords.getText()+"' and type='directeur'";
